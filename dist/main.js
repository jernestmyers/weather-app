...
function setWeatherDataObject(city, weatherData) {
  ...
  (0,_handleDOM__WEBPACK_IMPORTED_MODULE_0__.handleForecastData)(weeksForecast);
}
...
toggleUnits.addEventListener(`change`, (e) => {
  ...
  (0,_handleAPI_js__WEBPACK_IMPORTED_MODULE_0__.callCurrentWeatherAPI)(cityOnDisplay, unitsToDisplay);
});
